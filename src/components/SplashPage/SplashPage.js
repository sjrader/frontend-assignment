...
const MOVIE_URL = process.env.REACT_APP_API_DOMAIN + '/movie/76341?api_key=' + process.env.REACT_APP_MOVIE_DB_API_KEY;
...
const SplashPage = ({ movieTitle }) => {
    let defaultCallAPI = `https://api.themoviedb.org/3/discover/movie?api_key=` + API_KEY + `&language=en-US&sort_by=primary_release_date.desc&primary_release_date.lte=` + dateToday + `&include_adult=false&primary_release_year=` + year + `&with_original_language=en`
